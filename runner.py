...
# Create game
pygame.init()
pygame.display.set_caption("AI-Powered Minesweeper")

size = width, height = 610, 400
...
while True:
    ...
    # Display text
    text = "Oops, Try again" if lost else "You've Won" if game.mines == flags else ""
        ...
        if aiButton.collidepoint(mouse) and not lost:
            ...
            if move is None:
                ...
                if move is None:
                    ...
                    print("No known safe moves, AI making probabilistically calculated move.")
            else:
